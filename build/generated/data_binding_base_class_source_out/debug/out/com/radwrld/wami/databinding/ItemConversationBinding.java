...
public final class ItemConversationBinding implements ViewBinding {
  ...
  private ItemConversationBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView ivAvatar,
      @NonNull TextView tvContactName, @NonNull TextView tvLastMessage) {
  ...
  public static ItemConversationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemConversationBinding((ConstraintLayout) rootView, ivAvatar, tvContactName,
          tvLastMessage);
    }
