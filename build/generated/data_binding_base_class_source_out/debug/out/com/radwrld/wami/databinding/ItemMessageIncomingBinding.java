...
public final class ItemMessageIncomingBinding implements ViewBinding {
  ...
  private ItemMessageIncomingBinding(@NonNull LinearLayout rootView,
      @NonNull TextView tvMessageIn) {
    this.rootView = rootView;
    this.tvMessageIn = tvMessageIn;
  }
  ...
  public static ItemMessageIncomingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.tvMessageIn;
      TextView tvMessageIn = ViewBindings.findChildViewById(rootView, id);
      if (tvMessageIn == null) {
        break missingId;
      }

      return new ItemMessageIncomingBinding((LinearLayout) rootView, tvMessageIn);
    }
