...
public final class ActivityContactsBinding implements ViewBinding {
  ...
  private ActivityContactsBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout header,
      @NonNull ImageView ivBack, @NonNull RecyclerView rvContacts) {
  ...
  public static ActivityContactsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityContactsBinding((LinearLayout) rootView, header, ivBack, rvContacts);
    }
